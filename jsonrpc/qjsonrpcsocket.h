...
class  QJsonRpcAbstractSocket : public QObject
{
    Q_OBJECT
public:
...
class  QJsonRpcSocket : public QJsonRpcAbstractSocket
{
    Q_OBJECT
public:
...
class  QJsonRpcServiceSocket : public QJsonRpcSocket, public QJsonRpcServiceProvider
{
    Q_OBJECT
public:
